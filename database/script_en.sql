CREATE DATABASE IF NOT EXISTS master_pol;
use master_pol;
...
('Tip materiala 1', 0.001),
('Tip materiala 2', 0.0095),
('Tip materiala 3', 0.0028),
('Tip materiala 4', 0.0055),
('Tip materiala 5', 0.0034);

INSERT INTO products_types (name, coefficent) VALUES
('Laminat', 2.35),
('Massivnaya doska', 5.15),
('Parketnaya doska', 4.34),
('Probkovoe pokrytie', 1.5);
...
(1, 'Baza Stroitel', 'Aleksandra', 'Ivanova', 'Ivanovna', 'aleksandraivanova@ml.ru', '4931234567', '652050, Kemerovskaya oblast, gorod Yurga, ul. Lesnaya, 15', '2222455179', 7),
(2, 'Parket 29', 'Vasiliy', 'Petrov', 'Petrovich', 'vppetrov@vl.ru', '9871235678', '164500, Arkhangelskaya oblast, gorod Severodvinsk, ul. Stroiteley, 18', '3333888520', 7),
(3, 'Stroyservis', 'Andrey', 'Solovyev', 'Nikolaevich', 'ansolovev@st.ru', '8122233200', '188910, Leningradskaya oblast, gorod Primorsk, ul. Parkovaya, 21', '4440391035', 7),
(4, 'Remont i otdelka', 'Ekaterina', 'Vorobeva', 'Valeryevna', 'ekaterina.vorobeva@ml.ru', '4442223311', '143960, Moskovskaya oblast, gorod Reutov, ul. Svobody, 51', '1111520857', 5),
(1, 'MontazhPro', 'Stepan', 'Stepanov', 'Sergeevich', 'stepanov@stepan.ru', '9128883333', '309500, Belgorodskaya oblast, gorod Stary Oskol, ul. Rabochaya, 122', '5552431140', 10);

INSERT INTO products (article, name, product_type_id, min_price_partners) VALUES
('8758385', 'Parketnaya doska Yasen temnyy odnopolosnaya 14 mm', 3, 4456.90),
('8858958', 'Inzhenernaya doska Dub Frantsuzskaya elka odnopolosnaya 12 mm', 3, 7330.99),
('7750282', 'Laminat Dub dymchato-belyy 33 klass 12 mm', 1, 1799.33),
('7028748', 'Laminat Dub seryy 32 klass 8 mm s faskoy', 1, 3890.41),
('5012543', 'Probkovoe napolnoe kleevoe pokrytie 32 klass 4 mm', 4, 5450.59);
...
VALUES
-- Menedzhery
(1, 'Ivan', 'Petrov', 'Sergeevich', '1988-03-15', '40051234567', '123456789', TRUE, 'Khoroshee'),
(1, 'Maria', 'Sidorova', 'Igorevna', '1990-11-02', '40057891234', '987654321', FALSE, 'Otlichno'),

-- Programmist
(3, 'Andrey', 'Kuznetsov', 'Alekseevich', '1995-07-21', '40101234567', '111122223333', TRUE, 'Khoroshee'),

-- Bukhgalter
(2, 'Elena', 'Morozova', 'Pavlovna', '1982-05-08', '40104561234', '444455556666', TRUE, 'Udovletvoritelno'),

-- Okhrannik
(4, 'Sergey', 'Volkov', 'Vladimirovich', '1979-09-10', '40205678901', '555566667777', FALSE, 'Khoroshee'),

-- Uborshik
(5, 'Natalya', 'Orlova', 'Gennadyevna', '1975-12-25', '40307891234', '888899990000', TRUE, 'Khoroshee');

-- === 3. Polzovateli ===
-- Polzovateli, svyazannye s menedzherami
